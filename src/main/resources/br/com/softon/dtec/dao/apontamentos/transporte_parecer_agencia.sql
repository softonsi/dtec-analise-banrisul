...
WHERE EXISTS (
	...
	WHERE A.DT_APONTAMENTO = D.DT_APONTAMENTO
		...
		AND A.CD_STTUS_EVENTO_ATUAL = 6
);

INSERT INTO TB_EVENTO
(CD_EVENTO,DT_APONTAMENTO,CD_DOC_IDENTF_CLIE,CD_TP_IDENTF_CLIE,TX_MSG,CD_USU,CD_STTUS_EVENTO,TX_ARQUIVO_COMPL,NM_ARQUIVO_COMPL,DT_EVENTO,FL_CADSTR_DESATULZ,FL_RECUSA_ATULZ_CADSTR,NM_MIME_TYPE_ARQ_COMPL,CD_LOTE_APONTAMENTO, DS_JUSTIFICATIVA, DS_RESPOSTA_1, DS_RESPOSTA_2, DS_RESPOSTA_3, DS_RESPOSTA_4, FL_JUSTF_MOVTO, DS_JUSTF_MOVTO)
SELECT SQ_EVENTO.NEXTVAL CD_EVENTO,DT_APONTAMENTO,CD_DOC_IDENTF_CLIE,CD_TP_IDENTF_CLIE,TX_MSG,CD_USU,30 CD_STTUS_EVENTO,TX_ARQUIVO_COMPL,NM_ARQUIVO_COMPL,SYSTIMESTAMP AS DT_EVENTO,FL_CADSTR_DESATULZ,FL_RECUSA_ATULZ_CADSTR,NM_MIME_TYPE_ARQ_COMPL,CD_LOTE_APONTAMENTO, DS_JUSTIFICATIVA, DS_RESPOSTA_1, DS_RESPOSTA_2, DS_RESPOSTA_3, DS_RESPOSTA_4, FL_JUSTF_MOVTO, DS_JUSTF_MOVTO
FROM TB_EVENTO E
WHERE EXISTS (
    SELECT 1 FROM TB_APONTAMENTO A
    ...
    SELECT MAX(CD_EVENTO) FROM TB_EVENTO A
    WHERE A.DT_APONTAMENTO = E.DT_APONTAMENTO
		AND A.CD_LOTE_APONTAMENTO = E.CD_LOTE_APONTAMENTO
        AND A.CD_DOC_IDENTF_CLIE = E.CD_DOC_IDENTF_CLIE
        AND A.CD_TP_IDENTF_CLIE = E.CD_TP_IDENTF_CLIE
        AND A.CD_STTUS_EVENTO = 6
);

INSERT INTO TB_EVENTO_HIST
(CD_EVENTO,DT_APONTAMENTO,CD_DOC_IDENTF_CLIE,CD_TP_IDENTF_CLIE,TX_MSG,CD_USU,CD_STTUS_EVENTO,TX_ARQUIVO_COMPL,NM_ARQUIVO_COMPL,DT_EVENTO,FL_CADSTR_DESATULZ,FL_RECUSA_ATULZ_CADSTR,NM_MIME_TYPE_ARQ_COMPL,DT_HISTORICO,CD_LOTE_APONTAMENTO, DS_JUSTIFICATIVA, DS_RESPOSTA_1, DS_RESPOSTA_2, DS_RESPOSTA_3, DS_RESPOSTA_4, FL_JUSTF_MOVTO, DS_JUSTF_MOVTO)
SELECT CD_EVENTO,DT_APONTAMENTO,CD_DOC_IDENTF_CLIE,CD_TP_IDENTF_CLIE,TX_MSG,CD_USU,CD_STTUS_EVENTO,TX_ARQUIVO_COMPL,NM_ARQUIVO_COMPL,DT_EVENTO,FL_CADSTR_DESATULZ,FL_RECUSA_ATULZ_CADSTR,NM_MIME_TYPE_ARQ_COMPL,SYSTIMESTAMP AS DT_HISTORICO,CD_LOTE_APONTAMENTO, DS_JUSTIFICATIVA, DS_RESPOSTA_1, DS_RESPOSTA_2, DS_RESPOSTA_3, DS_RESPOSTA_4, FL_JUSTF_MOVTO, DS_JUSTF_MOVTO
FROM TB_EVENTO E
WHERE EXISTS (
	SELECT 1 FROM TB_APONTAMENTO A
	WHERE A.DT_APONTAMENTO = E.DT_APONTAMENTO
