...
Where Cd_Lote = 2014091801 
  ...
  And (T.Vl_Renda_Fat * (Select Vl_Param/100 From Tb_Regra_Parametro Where cd_regra = 90 and Nm_Campo_Param = 'pm_percRendaFat')) <
  (Select sum(vl_oper) vl_total From Tb_Trans_Anlse
