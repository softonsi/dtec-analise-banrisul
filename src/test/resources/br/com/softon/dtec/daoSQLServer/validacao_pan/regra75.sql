...
Where Cd_Lote    = 2014091801
  ...
  And  MONTHS_BETWEEN (dt_vencto, dt_trans) < (Select Vl_Param  From Tb_Regra_Parametro Where Cd_Versao_Sistema = 3 And Cd_Regra = 75 And Nm_Campo_Param = 'pm_qMes_PrazoCurto')
