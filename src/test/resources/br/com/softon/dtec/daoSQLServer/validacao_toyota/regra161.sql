...
WHERE ((CD_TP_PESSOA = 'F' and FL_MOVTA_JURIDICA = 1) OR (CD_TP_PESSOA = 'J'))
  ...
  AND I.VL_TOTAL > ((M.VL_TOTAL - I.VL_TOTAL) * (select vl_param/100 from TB_REGRA_PARAMETRO where CD_REGRA = 161 and CD_VERSAO_SISTEMA = 3 and NM_CAMPO_PARAM = 'pm_percPerfil'))
