...
WHERE CD_TP_PESSOA = 'F'
  ...
  AND I.VL_TOTAL > ((M.VL_TOTAL-I.VL_TOTAL) * (select vl_param/100 from TB_REGRA_PARAMETRO where CD_REGRA = 160 and CD_VERSAO_SISTEMA = 3 and NM_CAMPO_PARAM = 'pm_percPerfil'))
  ) s; 
